...
Join a guild(players):  Player enters Hall of joining and sits in chair of peril.  a GM must pull the 'lock' lever to secure the player, then the 'load' lever to have them join the guild.  You cannot join a guild if you belong to a guild already.
